...
function cartLoad(){
    ...
    cart.forEach(function(item){
        ...
        <div class="text-center pat"><button style="background-color:#ffd39e;color: black;" class="px-xl-2 px-1 rounded mt-3 ms-xl-3 exit"  id="exit">REMOVE</button></div>
        </div>
        ...
        <div class="col-3">
            <h5 class="text-center mt-5">$${mul}.00</h5>
        </div>
    ...
    let dele = document.querySelectorAll("#exit")
